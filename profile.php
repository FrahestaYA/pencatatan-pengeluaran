...
<div id="main-content"
    class="pb-24 max-w-md mx-auto bg-gray-50 dark:bg-gray-900 min-h-screen transition-all duration-200">
    <div class="bg-blue-600 pb-20 pt-8 px-6 rounded-b-[3rem] shadow-xl relative z-0 overflow-hidden">
        <!-- Decor Circle -->
        ...
        <div class="flex justify-between items-center mb-6 relative z-10">
            <div>
                ...
                <p class="text-blue-100 text-xs opacity-90">Kelola akun anda</p>
            </div>
    ...
    <div class="px-5 -mt-16 relative z-10">
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-6 flex flex-col items-center mb-6">

            <!-- Avatar Upload (Mobile Friendly Badge) -->
            <div class="relative mb-6 group" onclick="document.getElementById('avatarInput').click()">
                <div class="w-28 h-28 rounded-full p-1 bg-white shadow-lg cursor-pointer">
                ...
                <!-- Edit Badge -->
                <div
                    class="absolute bottom-1 right-1 bg-blue-500 text-white w-8 h-8 rounded-full flex items-center justify-center shadow-md border-2 border-white dark:border-gray-800 cursor-pointer active:scale-90 transition-transform">
            ...
            <form id="profileForm" class="w-full space-y-5">
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase mb-2 pl-1">Informasi Dasar</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-user text-gray-400"></i>
                        </div>
                        <input type="text" name="full_name" value="<?php echo htmlspecialchars($full_name); ?>"
                            class="w-full bg-gray-50 dark:bg-gray-700 border-none rounded-2xl py-3.5 pl-11 pr-4 text-sm text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-blue-100 transition-all placeholder-gray-400"
                ...
                <div class="relative">
                    ...
                    <textarea name="bio" rows="3"
                        class="w-full bg-gray-50 dark:bg-gray-700 border-none rounded-2xl py-3.5 pl-11 pr-4 text-sm text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-blue-100 transition-all placeholder-gray-400 resize-none"
                        placeholder="Tulis sedikit tentang anda..."><?php echo htmlspecialchars($bio); ?></textarea>
                </div>

                <div class="pt-2">
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-blue-500/30 active:scale-[0.98] transition-all">
                        Simpan Perubahan
                    </button>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
            <button onclick="toggleDarkMode()"
                ...
                <div class="flex items-center text-gray-700 dark:text-gray-200">
                    <div
                        class="w-9 h-9 rounded-full bg-indigo-50 dark:bg-indigo-900/50 text-indigo-500 flex items-center justify-center mr-3.5">
            ...
            <a href="categories.php"
                ...
                <div class="flex items-center text-gray-700 dark:text-gray-200">
                    <div
                        class="w-9 h-9 rounded-full bg-blue-50 dark:bg-blue-900/50 text-blue-500 flex items-center justify-center mr-3.5">
