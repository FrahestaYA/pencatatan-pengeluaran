        ...
        <form id="addExpenseForm" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="amount" required inputmode="numeric"
                        class="w-full bg-transparent border-b-2 border-gray-100 dark:border-gray-700 text-3xl font-bold text-gray-800 dark:text-white pl-10 focus:outline-none focus:border-blue-500 placeholder-gray-200"
                        placeholder="0">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="date" required value="<?php echo date('Y-m-d'); ?>"
                        class="w-full bg-gray-50 dark:bg-gray-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-100 outline-none">
                </div>
                <div>
                    <label
                    ...
                    <select name="category_id" id="category_select" required
                        class="w-full bg-gray-50 dark:bg-gray-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-blue-100 outline-none appearance-none">
                        <!-- Populated by JS -->
                    </select>
                </div>
            </div>
            ...
            <button type="submit"
                class="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 active:scale-95 transition-transform mt-4">
                Simpan
            </button>
        </form>
    </div>
